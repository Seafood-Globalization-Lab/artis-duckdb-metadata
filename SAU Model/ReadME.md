...
- **SAU_Duckdb_Creation.Rmd**: Generates a DuckDB database without metadata.
- **SAU_Duckdb_Creation_w_metadata.Rmd**: Generates a DuckDB database with metadata.
...
- `SAU_Duckdb_Creation.Rmd`: Script for DuckDB generation without metadata.
